...
from seed_vc_modules.commons import *
import time

import torchaudio
import librosa
from seed_vc_modules.commons import str2bool
...
def load_models(args):
    ...
    if not args.f0_condition:
        ...
        if args.checkpoint is None:
            ...
            dit_config_path = args.config
        # f0 extractor
        from seed_vc_modules.rmvpe import RMVPE
    ...
    # Load additional seed_vc_modules
    from seed_vc_modules.campplus.DTDNN import CAMPPlus
    ...
    if vocoder_type == 'bigvgan':
        from seed_vc_modules.bigvgan import bigvgan
        ...
        from seed_vc_modules.hifigan.generator import HiFTGenerator
        from seed_vc_modules.hifigan.f0_predictor import ConvRNNF0Predictor
    ...
    from seed_vc_modules.audio import mel_spectrogram
